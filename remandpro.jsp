...
String a2=request.getParameter("r");
String a3=request.getParameter("ct");
String a4=request.getParameter("hd");
String a5=request.getParameter("nhd");
Class.forName("com.mysql.jdbc.Driver");  
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/prisonSystem","root","root"); 
String q="insert into remandcase (name,remandTime,caseType,hearingDate,nextHearingDate) values(?,?,?,?,?) "; 
