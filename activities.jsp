...
<div><centre>
<h3><i>Insert activities details</i></h3>
<form action="activitiespro.jsp" method="get">
<select  name="iid" >
...
<input type="text" name="an" placeholder="activity_Name"  pattern="^[a-zA-Z]+$" title="Please enter valid name"/><br/><br/>
<input type="text" name="tl" placeholder="time_Limit"/><br/><br/>
<input type="text" name="pp" placeholder="place_of_play"/><br/><br/>
