...
String a2=request.getParameter("case");
String a3=request.getParameter("from");
String a4=request.getParameter("to");

Class.forName("com.mysql.jdbc.Driver");  
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/prisonSystem","root","root"); 
String q="insert into transfer (prisonerId,caseType,transferFrom,transferTo) values(?,?,?,?) "; 
