...
Class.forName("com.mysql.jdbc.Driver");  
  ...
  %>
   ...
   <tr>
                ...
                <td><p><h2><font color="black" face="bookman header">ACTIVITY_NAME</h2></p></font></td>
                <td><p><h2><font color="black" face="bookman header">TIME_LIMIT</h2></p></font></td>
                <td><p><h2><font color="black" face="bookman header">PLACE_OF_PLAY</h2></p></font></td>
                ...
                PreparedStatement st=con.prepareStatement("select * from activities ");
